...
unsigned int level2_data[] =
{
    ...
    3, 1, 2, 2, 2, 2, 2, 1, 1, 1, 3,
    3, 1, 2, 0, 2, 0, 2, 1, 1, 1, 3,
    3, 1, 2, 2, 2, 2, 2, 2, 2, 1, 3,
    3, 1, 1, 1, 1, 1, 2, 0, 2, 1, 3,
    3, 1, 1, 1, 1, 1, 2, 2, 2, 1, 3,
    3, 3, 3, 3, 3, 3, 3, 3, 3, 3, 3
};
...
void Level2::Initialize() {
    ...
    state.map = new Map(LEVEL2_WIDTH, LEVEL2_HEIGHT, level2_data, mapTextureID, 1.0f, 2, 2);
    ...
    state.enemies[0].startPosition = glm::vec3(5.0, 0.0, 0.0);
    ...
    state.enemies[2].startPosition = glm::vec3(5.0, -7.5, 0.0);
    state.enemies[2].target = &state.plants[2];
    state.enemies[3].startPosition = glm::vec3(5.0, 0.0, 0.0);
    state.enemies[3].target = &state.plants[3];
...
void Level2::Render(ShaderProgram *program) {
    ...
    if (state.win) {
        ...
        Util::DrawText(program, font_texture, "Press enter to main menu.", 0.6, -0.3, glm::vec3(1.45, -4.5, 0.0));
    } else if (state.lose) {
